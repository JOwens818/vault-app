...
const passwordTable = `CREATE TABLE IF NOT EXISTS ${process.env.SECRET_TABLE_NAME}(
  id SERIAL PRIMARY KEY,
  userid INT NOT NULL,
  ${process.env.SECRET_TABLE_COL_LABEL} TEXT NOT NULL,
  ${process.env.SECRET_TABLE_COL_ENCRYPTEDPW} TEXT NOT NULL,
  ${process.env.SECRET_TABLE_COL_IV} TEXT NOT NULL,
