...
const createUserSecret = async (userid, hashedLabel, enclabel, secret, iv) => {
  const params = [userid, hashedLabel, enclabel, secret, iv];
  const sql = `INSERT INTO ${secretTblName}
              (userid, ${hashedLabelCol}, ${encryptedLabelCol}, ${encryptedSecretCol}, ${ivCol}) 
              VALUES ($1, $2, $3, $4, $5)`;
